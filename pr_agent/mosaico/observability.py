...
def parse_observability_metadata(raw) -> dict[str, str]:  # pyright: ignore[reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType]
...
def mosaico_log_context(meta, context_id):  # pyright: ignore[reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType]
...
@contextlib.contextmanager
def langfuse_span(meta, context_id):  # pyright: ignore[reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType]
    ...
    try:
        ...
        with propagate_attributes(session_id=context_id, trace_name=meta.get("mosaico-root-task-name")):
            with lf.start_as_current_observation(as_type="span", name=AGENT_NAME,  # pyright: ignore[reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess,reportUnknownArgumentType]
                                                 **({"trace_context": trace_ctx} if trace_ctx else {})):  # pyright: ignore[reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess,reportUnknownArgumentType]
                yield
