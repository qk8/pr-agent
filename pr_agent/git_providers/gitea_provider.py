...
class GiteaProvider(GitProvider):
    ...
    def publish_persistent_comment(self, pr_comment: str,
                                   ...
                                   name='review',  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
    ...
    def publish_comment(self, comment: str, is_temporary: bool = False) -> dict[str, Any] | None:
        ...
        response = self.repo_api.create_comment(
            owner=self.owner,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            repo=self.repo,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            index=index,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            comment=comment
        )
        ...
        return comment_obj  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
    def edit_comment(self, comment, body : str):  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType]
        body = self.limit_output_characters(body, self.max_comment_chars)
        try:
            self.repo_api.edit_comment(
                owner=self.owner,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
                repo=self.repo,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
                comment_id=comment.get("comment_id") if isinstance(comment, dict) else comment.id,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
                comment=body
            )
        except ApiException as e:
    ...
    def publish_inline_comment(self,body: str, relevant_file: str, relevant_line_in_file: str, original_suggestion=None):  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType]
    ...
    def publish_inline_comments(self, comments: list[dict[str, Any]],body : str = "Inline comment") -> None:
        response = self.repo_api.create_inline_comment(
            owner=self.owner,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            repo=self.repo,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            pr_number=self.pr_number if self.enabled_pr else self.issue_number,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            body=body,
    ...
    def add_eyes_reaction(self, issue_comment_id: int, disable_eyes: bool = False) -> int | None:
        ...
        try:
            ...
            comment_ids = [comment.id for comment in comments]  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
    ...
    def get_line_link(self, relevant_file, relevant_line_start, relevant_line_end = None) -> str:  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType]
    ...
    def get_issue_comments(self) -> list[dict[str, Any]]:
        ...
        for c in comments:  # pyright: ignore[reportUnknownArgumentType,reportOptionalIterable,reportUnknownVariableType,reportGeneralTypeIssues]
    ...
    def get_pr_labels(self,update=False) -> list[str]:  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType]
        ...
        labels = self.repo_api.get_issue_labels(
            owner=self.owner,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            repo=self.repo,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            issue_number=self.pr_number  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
        )
        if not labels:
            self.logger.error("Failed to get PR labels")
            return []
    ...
    def get_repo_settings(self) -> bytes:
        ...
        response = self.repo_api.get_file_content(
            owner=self.owner,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            repo=self.repo,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            commit_sha=self.sha,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
    ...
    def is_supported(self, capability) -> bool:  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType]
    ...
    def publish_labels(self, labels: list[int]) -> None:
        ...
        response = self.repo_api.add_labels(
            owner=self.owner,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            repo=self.repo,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            issue_number=self.pr_number if self.enabled_pr else self.issue_number,  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            labels=labels
        )
    ...
    def remove_comment(self, comment) -> None:  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType]
...
class RepoApi(giteapy.RepositoryApi):
    ...
    def create_inline_comment(self, owner: str, repo: str, pr_number: int, body : str ,commit_id : str, comments: list[dict[str, Any]]):
        body = {  # pyright: ignore[reportUnknownArgumentType,reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess]
            "body": body,
            "comments": comments,
            "commit_id": commit_id,
        }
    ...
    def get_pr_commits(self, owner: str, repo: str, pr_number: int) -> list[dict[str, object]]:
