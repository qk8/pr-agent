...
class _AzureCommitInner:
    def __init__(self, raw):  # pyright: ignore[reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType]
...
class AzureDevopsProvider(GitProvider):
    ...
    def publish_inline_comments(self, comments: list[dict[str, object]], disable_fallback: bool = False):
            ...
            for comment in comments:
                try:
                    self.publish_comment(comment["body"],  # pyright: ignore[reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess,reportUnknownArgumentType]
                                        thread_context={
    ...
    def get_thread_context(self, thread_id: int) -> CommentThreadContext | None:  # pyright: ignore[reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType]
        try:
    ...
    def get_latest_commit_url(self) -> str:
        ...
        workspace = quote(self.workspace_slug, safe='')  # pyright: ignore[reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess,reportUnknownArgumentType]
        repo = quote(self.repo_slug, safe='')  # pyright: ignore[reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess,reportUnknownArgumentType]
