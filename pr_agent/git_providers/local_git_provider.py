...
class LocalGitProvider(GitProvider):
    ...
    def __init__(self, target_branch_name, incremental=False):  # pyright: ignore[reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType]
    ...
    def get_pr_description_full(self):
        ...
        commit_messages = " ".join([commit.message for commit in commits_diff])  # pyright: ignore[reportUnknownParameterType,reportMissingParameterType,reportUnknownMemberType,reportUnknownVariableType,reportCallIssue,reportGeneralTypeIssues,reportOperatorIssue,reportAssignmentType,reportFunctionMemberAccess,reportUnknownArgumentType]
